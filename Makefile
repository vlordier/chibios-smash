...
TESTS = test_mutex_deadlock test_semaphore test_priority_inversion test_chibios_patterns test_dpor_bench test_invariants test_timeout test_comprehensive test_context_safety test_object_lifecycle test_chibios_v2
